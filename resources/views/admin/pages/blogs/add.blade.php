        ...
        <form action="{{ route('admin.blog.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group mt-4">
                ...
                <img id="preview" src="#" alt="Image Preview"
                    style="display: none; max-width: 100%; height: 200px; margin-top: 10px;">
            </div>
            <div class="form-group mt-4">
                <label for="content">Content</label>
                <textarea class="form-control" id="mytextarea" name="content" rows="10"></textarea>
            </div>
            <button id="submit-bt" type="submit" class="btn btn-primary">Add Blog</button>
        </form>
    </div>
@endsection
@push('css')
